...
<div id="top_nav">
	<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
		<div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
			<img src="https://uxwing.com/wp-content/themes/uxwing/download/business-professional-services/erp-icon.png" width=120 height=50>        
          <button type="button" class="btn btn-sm bg-white btn-icon-text border" data-toggle="minimize">
            <span class="typcn typcn-th-menu">접</span>
          </button>
		</div>
