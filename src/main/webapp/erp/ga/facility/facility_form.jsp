						...
						<div class="card shadow-sm">
							...
							<form id="facilityForm" action="/facility" method="POST" onsubmit="return validateForm()">					
								...
								<div class="card-body p-4">
									...
									<div class="mb-3">
										<label for="facilityType" class="form-label text-muted">시설타입</label> <input type="text" class="form-control" id="facilityType" name="facilityType" required maxlength="30">
										<div class="invalid-feedback">시설타입을 입력해주세요 (최대 30자)</div>
									</div>
									<div class="mb-3">
