		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<div class="row">
						<div class="col-xl-7 d-flex grid-margin stretch-card mx-auto">
							<div class="card">
								<div class="card-body">
										...
										<div class="col-12">
											<div class="row justify-content-center">
												<div class="col-sm-6">
													...
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설번호 </div>
														<div class="fs-1">${FACILITY.facilityId }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설이름 </div>
														<div class="fs-1">${FACILITY.name }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설위치 </div>
														<div class="fs-1">${FACILITY.location }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설인원 </div>
														<div class="fs-1">${FACILITY.capacity }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설운영 </div>
														<div class="fs-1">${FACILITY.operatingStatus }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 시설타입 </div>
														<div class="fs-1">${FACILITY.facilityType }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 준공날짜 </div>
														<div class="fs-1">${FACILITY.completionDate }</div>
													</div>
													<div class="d-flex justify-content-between mb-4">
														<div class="text-secondary font-weight-medium fs-5"> 담당자 </div>
														<div class="fs-1">${FACILITY.workName }</div>
													</div>
