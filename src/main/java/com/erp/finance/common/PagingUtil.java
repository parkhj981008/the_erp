...
public class PagingUtil {
	...
	/**
	 * @param url 			: 페이징 적용 대상 주소  (서블릿주소)
	 * @param currentPage 	: 현재 페이지			
	 * @param totRecord 	: 전체 게시물수			DB에서 꺼내오면 됨
	 * @param blockCount 	: 한 블럭의 게시물 수
	 * @param blockPage  	: 한 화면에 보여질 블럭 수
	 **/
	...
	// [맨끝]
	if (currentPage < maxPage) {
	    pagingHtml.append("<a href='" + url + "?&currentPage=" + maxPage + "'>");
	    pagingHtml.append("맨끝");
	    pagingHtml.append("</a>");
	}
}
